...
% Uncomment the lines
 ...
 U_A = FormQ(B,t);  %Compute Left H a.k.a L.H
 V_A = eye( m, m ); %Compute Right H a.k.a R.H & truncate redundant unused elements
 Tranposed_Upper_B = triu(B,+1)'; %Transpose Upper Triangle to get R.H at the correct position to be processed by FormQ
 Subset_Tranposed_Upper_B =  Tranposed_Upper_B(1:m-1,1:m-1); 
 V_A( 2:m, 2:m ) = FormQ( Subset_Tranposed_Upper_B,r(1:m-1,1) );
